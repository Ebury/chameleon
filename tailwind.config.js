...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      'sans-condensed': ['Roboto Condensed', 'Noto Sans SC', 'Noto Sans TC', 'sans-serif'],
      // serif: ['Georgia', 'Cambria', '"Times New Roman"', 'Times', 'serif'],
      mono: ['Menlo', 'Monaco', 'Consolas', '"Liberation Mono"', '"Courier New"', 'Noto Sans SC', 'Noto Sans TC', 'monospace'],
    },
    // fontSize: {
    //   xs: '0.75rem',
    //   sm: '0.875rem',
