...
stories.add('basic', () => ({
  ...
  template: `
  <div class="ec">
    <EcPopover :placement="placement" :trigger="trigger">
  ...
  template: `
  <div class="ec" style="display: flex; height: 100vh">
    <div style="margin: auto">
      <h1>Header</h1>
      <EcPopover class="ec-mb-2" popoverClass="ec-popover custompop1" :placement="placement" :trigger="trigger">
      ...
      <EcPopover class="ec-mb-2" popoverClass="ec-popover custompop2" placement="top" :trigger="trigger">
      ...
      <EcPopover class="ec-mb-2" popoverClass="ec-popover custompop3" placement="bottom" :trigger="trigger">
      ...
      <EcPopover class="ec-mb-2" level="modal" placement="right" :trigger="trigger">
      ...
      <EcPopover class="ec-mb-2" popoverClass="ec-popover custompop5" placement="left" :trigger="trigger">
        <button v-ec-tooltip="'Left'" class="ec-btn custom5">Left</button>
        <div slot="popover">
          <button v-ec-close-popover>close</button>
          <h1 v-ec-tooltip="'Left pop tooltip'">Now you see me!</h1>
          <EcPopover class="ec-innerpop" placement="top" :trigger="trigger">
              <button>Foo</button>
