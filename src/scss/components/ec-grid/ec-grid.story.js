...
stories
  .add('rows', () => ({
    ...
    <div class="grid-story">
      ...
      <h2 class="grid-story__title">Grandparent: "ec-grid", Parent: "ec-grid__row" Child: "ec-col-1 to ec-12"</h2>
      <h2 class="grid-story__title">Normal</h2>
      <div class="ec-grid">
        <div class="ec-grid__row grid-story__container">
          <div
            v-for="i in 12"
      ...
      <h1 class="grid-story__title">Reverse</h1>
      <div class="ec-grid">
        <div class="ec-grid__row--reverse grid-story__container">
          <div
            v-for="i in 12"
            class="ec-col-1 grid-story__column">
            <p>.ec-col-1 <div>{{ i }}</div></p>
      ...
      <h1 class="grid-story__title">Wrap</h1>
      <div class="ec-grid">
        <div class="ec-grid__row ec-grid__row--wrap grid-story__container">
          <div
            v-for="i in 18"
            class="ec-col-1 grid-story__column">
            <p>.ec-col-1 <div>{{ i }}</div></p>
      ...
      <h1 class="grid-story__title">Offset</h1>
      <div class="ec-grid">
        <div class="ec-grid__row grid-story__container">
          <div class="ec-col-1 ec-offset-1 grid-story__column"><p>.ec-offset-1</p></div>
          <div class="ec-col-1 ec-offset-2 grid-story__column"><p>.ec-offset-2</p></div>
          <div class="ec-col-1 ec-offset-4 grid-story__column"><p>.ec-offset-4</p></div>
        </div>
      </div>

      <h1 class="grid-story__title">Various column combinations</h1>
      <div class="ec-grid">
        <div class="ec-grid__row grid-story__container">
          <div class="ec-col-2 grid-story__column"><p>.ec-col-2</p></div>
          <div class="ec-col-4 grid-story__column"><p>.ec-col-4</p></div>
          <div class="ec-col-6 grid-story__column"><p>.ec-col-6</p></div>
        </div>
      </div>
    `,
  }))
  .add('columns', () => ({
    ...
    <div class="grid-story">
      <h1 class="grid-story__title">12 Columns - 24 pixel gutters</h1>
      <h2 class="grid-story__title">Grandparent: "ec-grid", Parent: "ec-grid__col" Child: "ec-col-1 to ec-12"</h2>
      <div class="ec-grid">
        <div class="ec-grid__col grid-story__container">
          <div
            v-for="i in 12"
            class="ec-col-1 grid-story__column">
            <p>.ec-col-1 <div>{{i}}</div></p>
